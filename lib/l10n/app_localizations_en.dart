...
class AppLocalizationsEn extends AppLocalizations {
  ...
  @override
  String get otpSent => 'We sent a code to your phone.';
  ...
  @override
  String customerRequest(int number) => 'Customer Request #$number';
  ...
  @override
  String get introDescription => 'SmartTrust connects you with verified service providers. Request, compare, and track with confidence.';
  ...
  @override
  String get signupError => 'We could not create your account. Please try again.';
  ...
  @override
  String get startRequest => 'When you need help, your next trusted service starts here.';

  @override
  String get homeLoadError => 'We could not load your home data. Please try again.';

  @override
  String get noNearbyProviders => 'No nearby providers are available right now.';
  ...
  @override
  String get customerOnlyMessage => 'This home is available for customer accounts.';

  @override
  String distanceKm(String distance) => '${distance} km';
  ...
  @override
  String get categoryHelper => 'Choose a service so we can understand your request.';

  @override
  String get describeProblem => 'Tell us about the problem';

  @override
  String get problemHelper => 'A few details help the right professional prepare.';

  @override
  String get problemHint => 'Describe what needs attention...';

  @override
  String characters(int count, int max) => '${count}/${max} characters';
  ...
  @override
  String imagesOptional(int count) => 'Optional · Up to ${count} photos';
  ...
  @override
  String get locationPermissionDenied => 'Location access was denied. You can enter the address manually.';

  @override
  String get locationPermissionPermanentlyDenied => 'Location access is turned off. Enable it in Settings or enter the address manually.';

  @override
  String get locationUnavailable => 'We could not determine your location. Please enter the address manually.';
  ...
  @override
  String get reviewHelper => 'Everything look right? You can edit any section before submitting.';
  ...
  @override
  String get requestCreatedHelper => 'Your request is ready. Trusted providers can respond next.';
  ...
  @override
  String get locationRequired => 'Confirm a service location to continue.';

  @override
  String mediaLimit(int count) => 'You can add up to ${count} photos.';

  @override
  String get requestSubmitError => 'We could not create your request. Please try again.';
  ...
  @override
  String get categoryElectricalDescription => 'Power, wiring, and electrical repairs.';
  ...
  @override
  String get categoryCleaningDescription => 'A cleaner, more comfortable space.';

  @override
  String get categoryHvacDescription => 'Climate control, cooling, and air-conditioning services.';
  ...
  @override
  String get matchingProvidersHelper => 'We are looking for professionals who fit this request.';

  @override
  String providersFound(int count) => '${count} providers found';

  @override
  String get availableProviders => 'Available providers';

  @override
  String get providerSelectionHelper => 'Choose the professional you would like to work with for this request.';
  ...
  @override
  String confirmProviderQuestion(String name) => 'Select ${name} for this request?';

  @override
  String get providerSelected => 'Provider selected';

  @override
  String providerSelectedHelper(String name) => '${name} has been selected for your request.';
  ...
  @override
  String get matchingError => 'We could not find providers right now. Please try again.';

  @override
  String get providerSelectionError => 'This provider could not be selected. Please choose another provider.';

  @override
  String get requestContext => 'For this request';

  @override
  String requestReference(String id) => 'Request ${id}';
  ...
  @override
  String get statusRequestCreatedDescription => 'Your request has been created and is ready for the next step.';

  @override
  String get statusProviderSelected => 'Provider selected';

  @override
  String get statusProviderSelectedDescription => 'Your selected professional is connected to this request.';

  @override
  String get statusOnTheWay => 'Provider on the way';

  @override
  String get statusOnTheWayDescription => 'Your provider is preparing to reach the service location.';

  @override
  String get statusArrived => 'Provider arrived';

  @override
  String get statusArrivedDescription => 'Your provider has reached the service location.';

  @override
  String get statusInProgress => 'Service in progress';

  @override
  String get statusInProgressDescription => 'The service is currently being completed.';

  @override
  String get statusCompleted => 'Service completed';

  @override
  String get statusCompletedDescription => 'This service request has been completed.';
  ...
  @override
  String get liveLocationNotAvailable => 'Live location is not available in this demo.';

  @override
  String get demoLocationNote => 'Status updates are shown from the local tracking service.';

  @override
  String get trackingUnavailable => 'Tracking is not available for this request.';

  @override
  String get trackingError => 'We could not load tracking right now. Please try again.';

  @override
  String get requestNotFound => 'This request could not be found.';

  @override
  String get providerNoLongerAvailable => 'The selected provider is no longer available.';
  ...
  @override
  String get statusProviderAcceptedDescription => 'Your selected provider has confirmed the request.';

  @override
  String get statusProviderDeclined => 'Provider declined';

  @override
  String get statusProviderDeclinedDescription => 'Your selected provider could not accept this request.';

  @override
  String get providerRequestDetails => 'Request details';

  @override
  String get incomingRequestHelper => 'Review the request details before choosing an action.';
  ...
  @override
  String acceptRequestQuestion(String name) => 'Accept this request for ${name}?';
  ...
  @override
  String get declinedRequestHelper => 'The request was declined and remains available for a future decision.';
  ...
  @override
  String get providerOnlyMessage => 'This area is available for service provider accounts.';
  ...
  @override
  String get requestActionError => 'We could not update this request. Please try again.';
  ...
  @override
  String requestAttachmentsCount(int count) => '${count} photos attached';
