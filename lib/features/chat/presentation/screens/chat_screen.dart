      ...
      body: state.isLoading
          ...
          : state.error != null
              ...
              : Column(children: [
                  ...
                  _Composer(controller: _messageController, isSending: state.isSending, l10n: l10n, onSend: () => _send(query)),
                ]),
    );
  }
